# This file was copied from (test/ryu.jl) in the https://github.com/JuliaLang/julia repository.

# The Julia license is MIT: https://julialang.org/license
...
@testset "OutputOptions" begin
    # plus
    @test "+1" == Ryu.writeshortest(1.0, true, false, false)
    @test "-1" == Ryu.writeshortest(-1.0, true, false, false)
